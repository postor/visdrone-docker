...
datasetPath = 'F:\Datasets\obj_det\vidrone\visdrone2020\VisDrone2019-DET-val'; % dataset path
%resPath ='D:\cv1\to_github\MPFPN/tools/eval_visdrone\Cascade_FPN_Res50_COCO_1x_20190420_v2'; % result path
%resPath = 'D:\cv1\github_test\Weighted-Boxes-Fusion-master\model_ensemble_test\enemble_ressults';
resPath = 'D:\cv1\build\FPN_cascade_tf_1\test_result_txt';
%resPath = 'D:\cv1\build\FPN_tf1_tensorflow1\test_result_txt';
