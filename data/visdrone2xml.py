...
# 数据集根目录
root_dir = os.path.join(os.getcwd(), r"F:\Datasets\obj_det\vidrone\visdrone2020\VisDrone2019-DET-train/")
annotations_dir = root_dir + "annotations/"
image_dir = root_dir + "images/"
# xml目录
xml_dir = root_dir + "Annotations_VisDrone_XML/"
...
for filename in os.listdir(annotations_dir):
    ...
    with open(xml_name, 'w') as fout:
        ...
        fout.write('\t\t' + '<annotation>' + 'VisDrone-2019' + '</annotation>' + '\n')
        fout.write('\t\t' + '<image>' + 'flickr' + '</image>' + '\n')
        fout.write('\t\t' + '<flickrid>' + 'Unspecified' + '</flickrid>' + '\n')
        fout.write('\t' + '</source>' + '\n')

        fout.write('\t' + '<owner>' + '\n')
        fout.write('\t\t' + '<flickrid>' + 'Luis' + '</flickrid>' + '\n')
        fout.write('\t\t' + '<name>' + 'Luis' + '</name>' + '\n')
        fout.write('\t' + '</owner>' + '\n')
